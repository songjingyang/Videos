...
@inject('system')
@observer
export default class ManagementAccount extends React.Component<Props, State> {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: (text: string, record: any) => (
                        <span>
                            <a href="#" onClick={() => { this.CreateAdmin(record) }} >编辑</a>
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                if (params.page === 1) {
                    ...
                    params.ts = this.props.system.accountPage.ts;
                }
                if (!params.pageSize) {
                    params.pageSize = 20;
                }
                ...
                this.props.system.getAccountPage({
                    data: {
                        ...payload,
                    },
    ...
    handleSubmit = (e: KeyboardEvent) => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                this.getAccountPage(values);
            }
        });
    };
    ModalInfo = (bool: boolean) => {
    ...
    render() {
        ...
        return (
            <Card title="管理列表" bordered={false}
                ...
                <BackTop className="ant-back-top-inner" />
                {
                    this.state.visible && (
                        <Modal
                            ...
                            width={700}
                            onCancel={() => this.isCreateAdmin(false)}
                            footer={null}
                        >
                            <CreateAdmin
