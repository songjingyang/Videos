...
@inject('video')
@observer
export default class CreateVideo extends React.Component<Props, State> {
  ...
  render() {
    ...
    return (
      <Card bordered={false} title={this.props.data.id ? '编辑会员' : '添加会员'} className="CreateVideo">
