...
@inject('extension')
@observer
export default class ExtensionRecord extends React.Component<Props, State> {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                if (params.page === 1) {
                    ...
                    params.ts = this.props.extension.extensionRecord.ts;
                }
                if (!params.pageSize) {
                    params.pageSize = 20;
                }
                ...
                this.props.extension.getExtensionRecord({
                    data: {
                        ...payload,
                    },
    ...
    handleSubmit = (e: KeyboardEvent) => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                this.getExtensionRecord(values);
            }
        });
    };
    render() {
